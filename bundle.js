...
var callback = __webpack_require__(0);
...
var oembed = __webpack_require__(5);
...
window.forum = {};
window.forum.__proto__ = { callback, element, error, fn, init, oembed, option, rest, route, template }

var n = navigator,
uAgent = n.userAgent.toLowerCase(),
type = n.appName,
lang = (type=="Netscape") ? navigator.language : lang = navigator.userLanguage;
document.documentElement.lang = lang = lang.substr(0,2);
